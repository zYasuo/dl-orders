...
@Injectable()
export class MongoReservationAuditLogRepository extends ReservationAuditLogPort {
  private readonly collection = this.db.collection<TReservationAuditEvent & { _id?: unknown }>(
    COLLECTION,
  );
