...
function toCamelCase(str: string): string {
    const snakeToCamel = str.replace(/_([a-z])/g, (_: string, letter: string) => letter.toUpperCase());
...
function convertKeys(obj: unknown): unknown {
    ...
    if (typeof obj === 'object' && (obj as { constructor: unknown }).constructor === Object) {
...
export function snakeToCamelBody(_req: Request, res: Response, next: NextFunction): void {
    ...
    if (req.body && typeof req.body === 'object' && !Array.isArray(req.body) && (req.body as { constructor: unknown }).constructor === Object) {
